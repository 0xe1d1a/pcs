...
The matrix \textbf{t\_prev} contains the temprature values from the previous iteration, initially the start temperatures.
...
the compilation environment elsewhere, but the lack of an OpenACC compiler makes this problematic, since the framework
