...
\\\\
In this experiment we compared different widths and heights keeping the same amount of elements for us to see if the boundary affects the performance. %outcome here
\\\\
%graph here
\\\\
