...
the smearing of the start/end columns), we decided to give up on further investigation and move
...
Here, we have a figure depicting the performance of different matrices and nodes:
...
results mostly serve to confuse us further.
