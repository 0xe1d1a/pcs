...
The first three depict a comparison between pthreads, openMP and openACC
without doing reductions
...
Same comparison with reductions at every step (\texttt{-k 1}):
